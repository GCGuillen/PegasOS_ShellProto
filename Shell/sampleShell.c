...
{
	CD,CLEAR, TEXTPALETTE, BACKGROUNDPALETTE, USERCOLOR, DIRECTORYCOLOR,
	MENUCOLOR, MENUCOLOR1, MENUCOLOR2, MENUCOLOR3, MENUCOLOR4,
	DEBUG, USERNAME, LOGIN, USER, CURRENTDIR,
...
const char* commandString(int index)
{
	...
	switch (index)
	{
		case CURRENTDIR: strcpy(result,"currentdir"); break;
		case CD: strcpy(result,"cd");break;
...
void displayCurrentDir()
{
	...
	printf("04/18/2020  03:17 PM               412 ascii_printer.c\n");
	printf("04/18/2020  03:17 PM             3,425 cog_ascii\n");
	printf("04/18/2020  03:17 PM             3,425 cog_ascii.txt\n");
	printf("04/18/2020  03:17 PM             4,448 hashTest.c\n");
	printf("04/18/2020  03:17 PM             6,130 pegasus_ascii\n");
	printf("04/18/2020  03:17 PM             3,466 pegasus_ascii2\n");
	printf("04/18/2020  01:37 PM                49 README.md\n");
	printf("04/18/2020  06:29 PM            21,233 shell.c\n");
	printf("04/18/2020  06:29 PM            57,995 shell.exe\n");
	printf("04/18/2020  03:17 PM             3,880 tableofcontents_notes.txt\n\n");
...
int main(void)
{
	...
	do
	{
		...
		else if(strcmp(command,commandString(CD))==0)
		{
			//changeDirectory();
		}
		else if(strcmp(command,commandString(CURRENTDIR))==0)
		{
			displayCurrentDir();
		}
